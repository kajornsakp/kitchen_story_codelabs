                ...
                children: [
                  ...
                  SingleChildScrollView(
                    ...
                    child: Padding(
                      ...
                      child: FutureBuilder(
                        future: _kitchenService.loadRecommendations(),
                        builder: (BuildContext context, AsyncSnapshot<Recommendation> snapshot) {
                          if (snapshot.connectionState == ConnectionState.waiting) {
                            ...
                            if (snapshot.hasError) {
                              ...
                              return Row(
                                children: snapshot.data?.recommendations.map((e) => RecommendationCard(model: e)).toList() ?? [],
                              );
                            }
                          }
                        },
                        ...
                        builder: (BuildContext context, AsyncSnapshot<Categories> snapshot) {
                          if (snapshot.connectionState == ConnectionState.waiting) {
                            ...
                            if (snapshot.hasError) {
                              ...
                              return Column(
                                children: snapshot.data?.categories.map((e) => CategoryCard(model: e)).toList() ?? [],
                              );
                            }
                          }
                        },
